...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900 dark:bg-zinc-950 text-gray-400">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="text-center md:text-left">
            <h2 className="text-3xl font-bold text-amber-500">BiteBox</h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/recipes" className="hover:text-amber-500 transition-colors duration-300">
                  Recipes
                </Link>
              </li>
              <li>
                <Link href="/streams" className="hover:text-amber-500 transition-colors duration-300">
                  Live Streams
                </Link>
              </li>
              <li>
                <Link href="/menu" className="hover:text-amber-500 transition-colors duration-300">
                  AI Meal Hub
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/custoratings" className="hover:text-amber-500 transition-colors duration-300">
                  Leave a Review
                </Link>
              </li>
            </ul>
